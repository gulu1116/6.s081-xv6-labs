...
00000000000011ba <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    1252:	de278793          	addi	a5,a5,-542 # 8030 <big.1274>
...
0000000000002044 <bigargtest>:
{
  ...
  close(fd);
    ...
    20ac:	e8878793          	addi	a5,a5,-376 # 7f30 <args.1811>
    20b0:	00006697          	auipc	a3,0x6
    20b4:	f7868693          	addi	a3,a3,-136 # 8028 <args.1811+0xf8>
    ...
    20cc:	e6858593          	addi	a1,a1,-408 # 7f30 <args.1811>
